...
from data_models import Message, Role
...
class Tokenizer:
    def __init__(self, model_path: str):
        ...
        self._model.Init(model_file=model_path, add_bos=False, add_eos=False)
        self._sep = "▁"
...
def load_model(folder: str) -> Tuple[Mistral, Tokenizer]:
